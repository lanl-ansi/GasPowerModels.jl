function constraint_heat_rate(
    gpm::AbstractGasPowerModel, n::Int, delivery_index::Int, dispatchable::Int)
    ...
    gpm.con[:heat_rate][delivery_index] = c # TODO: Use a convenience function.
end


function constraint_heat_rate(
    gpm::AbstractGasPowerModel, n::Int, delivery_index::Int, generator_index::Int,
